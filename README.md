...
When Inno Setup 7 or the project-local compiler is available, the build also produces the conventional `StatementImporter-1.1.0-Setup-x64.exe` installer from `installer\StatementImporter.iss`.
